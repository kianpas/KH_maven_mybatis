...
<body>
	<div id="student-container">
		...
		<hr />
		<c:choose>
			<c:when test="${not empty param.no && empty student}">
				<p>해당학생이 존재하지 않습니다.</p>
			</c:when>
			<c:otherwise>
				<h1>학생 정보 수정</h1>
		...
		<form action="${pageContext.request.contextPath}/student/deleteStudent.do" method="post" id="deleteFrm">
			...
			$.ajax({
				...
				success : data => {
					...
					if(data){
						...
						.append("<tr><th>등록일</th><td>" + data.reg_date + "</td></tr>")
